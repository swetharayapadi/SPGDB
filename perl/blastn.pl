...
Main_Menu();
$input_Nseq = param ('input_nucl');
open (OUT,">/var/apache/cgi-bin/SPGDB/dummy.txt") || die "$!";
print OUT "$input_Nseq";
close (OUT);
#print "###### $input_Nseq##########";
system("/var/apache/cgi-bin/SPGDB/ncbi-blast-2.2.29+/bin/blastn -db /var/apache/cgi-bin/SPGDB/ncbi-blast-2.2.29+/bin/db/Nucleotide_sequence -query /var/apache/cgi-bin/SPGDB/dummy.txt >/var/apache/cgi-bin/SPGDB/blast_output.txt");
...
print "</div>";
print "<p class = \"reshead\"> BlastN results </p>";
