...
print "<td>&nbsp&nbsp</td><td width=35><a style='text-decoration: none;'href = ?pagenum=".$page_info->first_page."$strnn".">&nbsp&nbsp<img class = \"pagefirst\" src = \"/SPGDB/images/first.png\"/> </a></td>";
